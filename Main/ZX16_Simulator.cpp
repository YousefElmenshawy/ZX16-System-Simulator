...
ZX16_Simulator::ZX16_Simulator() {
    ...
    if (!hitBuffer.loadFromFile("C:/Users/ASUS Zenbook/Downloads/ZX16-System-Simulator-363c00f78311201d110a1757c9097253b8d97d07/ZX16-System-Simulator-363c00f78311201d110a1757c9097253b8d97d07/Main/ballhit.wav"))
        cerr << "Error loading hit sound file.\n";
    else hitSound.setBuffer(hitBuffer);
    if (!loseBuffer.loadFromFile("C:/Users/ASUS Zenbook/Downloads/ZX16-System-Simulator-363c00f78311201d110a1757c9097253b8d97d07/ZX16-System-Simulator-363c00f78311201d110a1757c9097253b8d97d07/Main/balllose.wav"))
...
bool ZX16_Simulator::executeSysType(const Instruction& inst) {
    ...
    case 4: {
        int frequency = registers[6];   //a0
        int duration = registers[7];  // a1
